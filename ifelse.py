...
#### CALCULATE THE LEAVE PERCENTAGE ####

##workDay=int(input("Enter the total number of working days:"))
##leaveDays=int(input("Enter the number of absent day:"))
##percentageLeave=(leaveDays/100)*workDay
##if percentageLeave>=75:
##    print ("Your percentage is", percentageLeave, "You can attend exam ")
##else:
##    print("Your percentage is", percentageLeave, "You cannot attend the exam")
